    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Hall Management</a>
            </div>
            ...
            <div class="header-right">
              ...
              <a href="message-task.html" class="btn btn-info" title="New Message"><b>30 </b><i class="fa fa-envelope-o fa-2x"></i></a>
                ...
                <a href="loginform.php" class="btn btn-danger" title="Logout"><i class="fa fa-exclamation-circle fa-2x"></i></a>
                ...
                <ul class="nav" id="main-menu">
                    <li>
                         ...
                         <ul class="nav nav-second-level">
                             ...
                             <li>
                                 <a href="viewHall.php"><i class="fa fa-square-o "></i>Room</a>
                             </li>
                             <li>
