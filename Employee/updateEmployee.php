...
if(isset($_GET['updateEmployee'])){
    ...
    $q2="UPDATE person SET hall.person.first_name='$f_Name', hall.person.last_name='$l_Name', hall.person.address_number='$Address_number', hall.person.address_street='$Address_street', hall.person.address_city='$Address_city', hall.person.address_country='$Address_country', hall.person.gender='$Gender' WHERE hall.person.id='$e_id'";
