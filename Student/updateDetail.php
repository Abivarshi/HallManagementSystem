...
if(isset($_GET['updateStudent'])){
    ...
    $q2="UPDATE person SET hall.person.first_name='$f_Name', hall.person.last_name='$l_Name', hall.person.address_number='$Address_number', hall.person.address_street='$Address_street', hall.person.address_city='$Address_city', hall.person.address_country='$Address_country', hall.person.gender='$Gender', hall.person.date_of_birth=$Date_of_Birth WHERE hall.person.id='$s_id'";
